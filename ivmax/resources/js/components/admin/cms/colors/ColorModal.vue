                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <text-field
                                    ...
                                    name="hex"
                                    :maxlength="7"
                                    placeholder="Enter hex value..." type="text"
                                />
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    computed: {
        title() {
            return this.color ? "Edit Color" : "Add Color";
        },
    },
    methods: {
        showModal() {
        ...
        submitForm() {
            ...
            if (this.color) {
                method = "post"; //put
                path = route("colors.update", this.color);
                message = "Color has been updated.";
                this.form._method = 'put';
            } else {
                method = "post";
                path = route("colors.store");
