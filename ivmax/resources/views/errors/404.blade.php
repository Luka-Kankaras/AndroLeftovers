...
@section('content')
    ...
    <section
        class="error__section error__404__section section__top d-flex flex-column justify-content-around align-items-space-between py-5 text-center">
        <div class="img-wrap">
            <img data-src="{{ asset('assets/images/errors/404.png') }}" alt="Error 404"
