    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-7 text-center">
                ...
                <a href="https://hr.ivmax.com/" class="btn btn__transparent btn__region mx-auto my-2 m-md-3">Croatia</a>
                <a href="https://cz.ivmax.com/" class="btn btn__transparent btn__region mx-auto my-2 m-md-3">Czech
                    Republic</a>
                <a href="https://me.ivmax.com/"
                    class="btn btn__transparent btn__region mx-auto my-2 m-md-3">Montenegro</a>
                <a href="https://sr.ivmax.com/" class="btn btn__transparent btn__region mx-auto my-2 m-md-3">Serbia</a>
                <a href="https://it.ivmax.com/" class="btn btn__transparent btn__region mx-auto my-2 m-md-3">Italy</a>
                <a href="{{ url('/') }}" class="btn btn__transparent btn__region mx-auto my-2 m-md-3"
